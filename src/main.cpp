...
M5.begin();                
  ...
  M5.Lcd.printf(
      "Hello RID");  //Serial output format string. 
    delay(1000);            //（x,y） 
    M5.Lcd.setCursor(
      100, 100);  //Move the cursor position to (x,y).
  M5.Lcd.setTextColor(
      RED);  //Set the font color to white. 
 ...
 M5.begin();                
  ...
  M5.Lcd.setCursor(
      50, 100);  //Move the cursor position to (x,y).
  M5.Lcd.setTextColor(
      YELLOW);  //Set the font color to white. 
  M5.Lcd.setTextSize(3);  //Set the font size.  
  M5.Lcd.printf(
      "Hello RID");  //Serial output format string. 
    delay(1000);            //（x,y） 
...
void loop() {
  ...
  for (i = 0; i < MAX_UAVS; ++i) {
    ...
    //M5.Lcd.printf(uavs[i].lat_d,7) ;
    M5.Lcd.printf("Lat:%.7f",uavs[i].lat_d) ;
    
    M5.Lcd.setCursor(30, 120, 2);
    M5.Lcd.printf("Lon:%.7f",uavs[i].long_d) ;
    //M5.Lcd.printf(uavs[i].long_d,7) ;
